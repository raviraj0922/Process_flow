...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <h2 class="text-center text-primary mb-4">Your Progress Summary</h2>
    <p class="text-center">Hello, <strong><?php echo htmlspecialchars($_SESSION['user_email']); ?></strong></p>

    <div class="progress-container">
        <?php for ($i = 1; $i <= $total_stages; $i++): ?>
            <div class="stage <?php echo in_array($i, $completed_stages) ? 'completed' : ($i == $current_stage ? 'current' : 'pending'); ?>">
                <span>Stage <?php echo $i; ?></span>
                <span>
                    <?php 
    ...
    <div class="btn-container">
        <a href="user_form.php" class="btn btn-primary">Continue to Current Stage</a>
        <a href="user_dashboard.php" class="btn btn-danger">Back to Dashboard</a>
    </div>
</div>
    </section>
      <!-- <section> close -->
