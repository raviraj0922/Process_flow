...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <h2 class="text-center text-primary mb-4">Final Submission Summary</h2>

    <?php foreach ($questions_by_stage as $stage => $questions): ?>
        <div class="stage-container">
            <h4 class="text-white bg-primary p-2 rounded">Stage <?php echo $stage; ?> Responses</h4>
            <?php foreach ($questions as $q): 
                ...
                <div class="question-row">
                    ...
                    <div class="answer-text"><?php echo htmlspecialchars($answer); ?></div>
                </div>
            <?php endforeach; ?>
        </div>
        <?php endforeach; ?>
                ...
                <div class="card-body">
                    <ul>
                        <?php foreach ($stage_completion as $stage => $percentage): ?>
                            <li><strong>Stage <?php echo $stage; ?>:</strong> <?php echo $percentage; ?>% Completed</li>
                        <?php endforeach; ?>
                    </ul>
        ...
        <div class="submit-container">
            <form method="post">
                ...
                <a href="user_form.php" class="btn btn-warning">Edit Answers</a>
                <a href="user_dashboard.php" class="btn btn-danger">Dashboard</a>
            </form>
        </div>
